"""Criando shcema raw_mv

Revision ID: 58e057ca252b
Revises: 
Create Date: 2025-01-19 19:43:04.466751
...
def upgrade() -> None:
    ...
    op.execute("CREATE SEQUENCE public.id_ent_pro_seq")
    op.create_table('ent_pro',
    ...
    op.execute("CREATE SEQUENCE public.id_especie_seq")
    ...
    op.execute("CREATE SEQUENCE public.id_est_pro_seq")
    op.create_table('est_pro',
    ...
    op.execute("CREATE SEQUENCE public.id_estoque_seq")
    ...
    op.execute("CREATE SEQUENCE public.id_fornecedor_seq")
    ...
    op.execute("CREATE SEQUENCE public.id_itent_pro_seq")
    op.create_table('itent_pro',
    ...
    op.execute("CREATE SEQUENCE public.id_itmvto_estoque_seq")
    op.create_table('itmvto_estoque',
    ...
    op.execute("CREATE SEQUENCE public.id_itord_pro_seq")
    op.create_table('itord_pro',
    ...
    op.execute("CREATE SEQUENCE public.id_itsol_com_seq")
    op.create_table('itsol_com',
    ...
    op.execute("CREATE SEQUENCE public.id_lot_pro_seq")
    op.create_table('lot_pro',
    ...
    op.execute("CREATE SEQUENCE public.id_mot_cancel_seq")
    op.create_table('mot_cancel',
    ...
    op.execute("CREATE SEQUENCE public.id_mvto_estoque_seq")
    op.create_table('mvto_estoque',
    ...
    op.execute("CREATE SEQUENCE public.id_ord_com_seq")
    op.create_table('ord_com',
    ...
    op.execute("CREATE SEQUENCE public.id_produto_seq")
    ...
    op.execute("CREATE SEQUENCE public.id_setor_seq")
    ...
    op.execute("CREATE SEQUENCE public.id_sol_com_seq")
    op.create_table('sol_com',
    ...
    op.execute("CREATE SEQUENCE public.id_uni_pro_seq")
    op.create_table('uni_pro',
...
def downgrade() -> None:
    ...
    op.execute("DROP SEQUENCE public.id_uni_pro_seq")

    op.drop_table('sol_com')
    op.execute("DROP SEQUENCE public.id_sol_com_seq")

    op.drop_table('setor')
    op.execute("DROP SEQUENCE public.id_setor_seq")

    op.drop_table('produto')
    op.execute("DROP SEQUENCE public.id_produto_seq")

    op.drop_table('ord_com')
    op.execute("DROP SEQUENCE public.id_ord_com_seq")

    op.drop_table('mvto_estoque')
    op.execute("DROP SEQUENCE public.id_mvto_estoque_seq")

    op.drop_table('mot_cancel')
    op.execute("DROP SEQUENCE public.id_mot_cancel_seq")

    op.drop_table('lot_pro')
    op.execute("DROP SEQUENCE public.id_lot_pro_seq")

    op.drop_table('itsol_com')
    op.execute("DROP SEQUENCE public.id_itsol_com_seq")

    op.drop_table('itord_pro')
    op.execute("DROP SEQUENCE public.id_itord_pro_seq")

    op.drop_table('itmvto_estoque')
    op.execute("DROP SEQUENCE public.id_itmvto_estoque_seq")

    op.drop_table('itent_pro')
    op.execute("DROP SEQUENCE public.id_itent_pro_seq")

    op.drop_table('fornecedor')
    op.execute("DROP SEQUENCE public.id_ent_pro_seq")
    
    op.drop_table('estoque')
    op.execute("DROP SEQUENCE public.id_fornecedor_seq")

    op.drop_table('est_pro')
    op.execute("DROP SEQUENCE public.id_est_pro_seq")

    op.drop_table('especie')
    op.execute("DROP SEQUENCE public.id_especie_seq")
